...
INSERT INTO `controlador` VALUES (1,'Placa 1',1,'Manuel Fuentes 833, San Isidro','Primera placa impresa',-12.1011250,-77.0297990,'admin','36h8Ro/XLskEHNmkAZeDofUTsQ9bDd+whJewEv2MqmA=','SERIE1','172.16.3.180','255.255.0.0','172.16.0.1',3333,'Juan','Juan',0,0,1);
...
INSERT INTO `lectortarjeta` VALUES (1,'Lector 1'),(2,'Lector 2'),(3,'Lector 3'),(4,'Lector 4'),(5,'Lector 5'),(6,'Lector 6'),(7,'Lector 7'),(8,'Lector 8'),(9,'Lector 9');
...
INSERT INTO `pinesentrada` VALUES (1,1,1,'Entrada 1',0,0),(2,2,1,'Entrada 2',0,0),(3,3,1,'Entrada 3',0,0),(4,4,1,'Entrada 4',0,0),(5,5,1,'Entrada 5',0,0),(6,6,1,'Entrada 6',0,0),(7,7,1,'Entrada 7',0,0),(8,8,1,'Entrada 8',0,0),(9,9,1,'Entrada 9',0,0),(10,10,1,'Entrada 10',0,0),(11,11,1,'Entrada 11',0,0),(12,12,1,'Entrada 12',0,0),(13,13,1,'Entrada 13',0,0),(14,14,1,'Entrada 14',0,0),(15,15,1,'Entrada 15',0,0),(16,16,1,'Entrada 16',0,0),(17,17,1,'Entrada 17',0,0),(18,18,1,'Entrada 18',0,0),(19,19,1,'Entrada 19',0,0),(20,20,1,'Entrada 20',0,0),(21,21,1,'Entrada 21',0,0),(22,22,1,'Entrada 22',0,0),(23,23,1,'Entrada 23',0,0),(24,24,1,'Entrada 24',0,0),(25,25,1,'Entrada 25',0,0),(26,26,1,'Entrada 26',0,0),(27,27,1,'Entrada 27',0,0),(28,28,1,'Entrada 28',0,0),(29,29,1,'Entrada 29',0,0),(30,30,1,'Entrada 30',0,0),(31,31,1,'Entrada 31',0,0),(32,32,1,'Entrada 32',0,0),(33,33,1,'Entrada 33',0,0),(34,34,1,'Entrada 34',0,0),(35,35,1,'Entrada 35',0,0),(36,36,1,'Entrada 36',0,0),(37,37,1,'Entrada 37',0,0),(38,38,1,'Entrada 38',0,0),(39,39,1,'Entrada 39',0,0);
...
--
-- Current Database: `nodo1`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `nodo1` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
--
-- Table structure for table `registroenergia2024`
--

DROP TABLE IF EXISTS `registroenergia2024`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `registroenergia2024` (
  `re_id` bigint NOT NULL AUTO_INCREMENT,
  `me_id` int NOT NULL,
  `voltaje` float NOT NULL,
  `amperaje` float NOT NULL,
  ...
  PRIMARY KEY (`re_id`),
  KEY `fk_registroenergia_medidorenergia_me_id_idx` (`me_id`),
  CONSTRAINT `fk_registroenergia_medidorenergia_me_id2024` FOREIGN KEY (`me_id`) REFERENCES `medidorenergia` (`me_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `registroenergia2024`
--

LOCK TABLES `registroenergia2024` WRITE;
/*!40000 ALTER TABLE `registroenergia2024` DISABLE KEYS */;
/*!40000 ALTER TABLE `registroenergia2024` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `registroentrada2024`
--

DROP TABLE IF EXISTS `registroentrada2024`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `registroentrada2024` (
  `rentd_id` bigint NOT NULL AUTO_INCREMENT,
  `pin` tinyint NOT NULL,
  `estado` tinyint NOT NULL,
  `fecha` timestamp NOT NULL,
  ...
  PRIMARY KEY (`rentd_id`),
  KEY `fk_registroentrada_equipoentrada_ee_id_idx` (`ee_id`),
  CONSTRAINT `fk_registroentrada_equipoentrada_ee_id2024` FOREIGN KEY (`ee_id`) REFERENCES `general`.`equipoentrada` (`ee_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `registroentrada2024`
--

LOCK TABLES `registroentrada2024` WRITE;
/*!40000 ALTER TABLE `registroentrada2024` DISABLE KEYS */;
/*!40000 ALTER TABLE `registroentrada2024` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `registrosalida2024`
--

DROP TABLE IF EXISTS `registrosalida2024`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `registrosalida2024` (
  `rs_id` bigint NOT NULL AUTO_INCREMENT,
  `pin` tinyint NOT NULL,
  `estado` tinyint NOT NULL,
  `fecha` timestamp NOT NULL,
  ...
  PRIMARY KEY (`rs_id`),
  KEY `fk_registrosalida_equiopsalida_es_id_idx` (`es_id`),
  CONSTRAINT `fk_registrosalida_equiopsalida_es_id2024` FOREIGN KEY (`es_id`) REFERENCES `general`.`equiposalida` (`es_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `registrosalida2024`
--

LOCK TABLES `registrosalida2024` WRITE;
/*!40000 ALTER TABLE `registrosalida2024` DISABLE KEYS */;
/*!40000 ALTER TABLE `registrosalida2024` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `registrotemperatura2024`
--

DROP TABLE IF EXISTS `registrotemperatura2024`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `registrotemperatura2024` (
  `rtmp_id` bigint NOT NULL AUTO_INCREMENT,
  `st_id` int NOT NULL,
  `valor` float NOT NULL,
  `fecha` timestamp NOT NULL,
  PRIMARY KEY (`rtmp_id`),
  KEY `fk_registrotemperatura_sensortemperatura_st_id_idx` (`st_id`),
  CONSTRAINT `fk_registrotemperatura_sensortemperatura_st_id2024` FOREIGN KEY (`st_id`) REFERENCES `sensortemperatura` (`st_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `registrotemperatura2024`
--

LOCK TABLES `registrotemperatura2024` WRITE;
/*!40000 ALTER TABLE `registrotemperatura2024` DISABLE KEYS */;
/*!40000 ALTER TABLE `registrotemperatura2024` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-07-25 12:18:08
