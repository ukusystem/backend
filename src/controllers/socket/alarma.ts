...
// export const alarmaSocket = async (io: Server, socket: Socket) => {
//   let intervalId: NodeJS.Timeout | null = null; 
//   if (!intervalId) {
//     intervalId = setInterval(async () => {
//       const nspAlarmas = socket.nsp;
//       const [, , ctrl_id] = nspAlarmas.name.split("/"); // Namespace: "/alarmas/nodo_id/"
      
//       const registroAlarmas = await MySQL2.executeQuery<RegistroEntradaRowDataSocket[]>({sql:`SELECT * FROM ${"nodo" + ctrl_id}.registroentrada ORDER BY rentd_id DESC LIMIT 5`})

//       socket.emit("alarmas", registroAlarmas);
//     }, 1000);
//   }
